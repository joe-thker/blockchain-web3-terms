...
contract BasicNode {
    ...
    // Fee required for node registration.
    ...
    /**
     * @notice Update the admin address. Only the current admin can call.
    ...
    /**
     * @notice Withdraw collected registration fees. Only admin can call.
    ...
    /**
     * @dev Fallback receive function to accept Ether.
     */
