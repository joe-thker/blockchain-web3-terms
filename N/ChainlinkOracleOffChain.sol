...
/**
 * @title ChainlinkOracleOffChain
 * @notice Fetches off‑chain JSON data via a Chainlink oracle.
 *         - Owner configures LINK token, oracle, jobId, fee.
 *         - Anyone can request data by URL & JSON path.
 *         - Callback writes the result into a public mapping.
 */
contract ChainlinkOracleOffChain is ChainlinkClient, Ownable {
    using Chainlink for Chainlink.Request;

    /// @notice LINK token address for this network
