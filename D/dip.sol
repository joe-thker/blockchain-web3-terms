...
/// @title Dip
/// @notice A dynamic, optimized ERC20 token named "Dip." The contract owner can mint and burn tokens,
/// making the total supply flexible. Adjust or rename as needed in real deployments.
contract Dip is ERC20, Ownable, ReentrancyGuard {
    /// @notice Constructor sets the token name, symbol, and initial supply minted to the owner.
    ...
    /// @param amount The quantity of tokens (in smallest units) to burn.
