...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bail-In"] = "A resolution mechanism for financial institutions where creditors, depositors, and shareholders are required to absorb losses by converting a portion of their claims into equity, thus recapitalizing the institution internally. This mechanism avoids taxpayer-funded bailouts and promotes risk management.";
        ...
        emit TermAddedOrUpdated("Bail-In", terms["Bail-In"]);
    }
