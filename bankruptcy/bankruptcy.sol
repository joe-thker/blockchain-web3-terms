...
/// @notice A contract to store and retrieve various financial, legal, and technical terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bankruptcy"] = "A legal process in which an individual or company declares inability to repay debts. Bankruptcy proceedings may involve debt discharge, restructuring, or asset liquidation, providing relief to debtors and a fair process for creditors.";
        ...
        emit TermAddedOrUpdated("Bankruptcy", terms["Bankruptcy"]);
    }
