...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Backstop"] = "A financial guarantee or support mechanism provided by a third party to ensure market stability or the completion of a securities offering. It is used to secure unsold securities, provide liquidity during market stress, and enhance investor confidence.";
        ...
        emit TermAddedOrUpdated("Backstop", terms["Backstop"]);
    }
