...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Balloon Loan"] = "A loan structure in which the borrower makes small periodic payments over the term of the loan, with a large lump-sum balloon payment due at the end. This is used for short-term financing, lowering monthly payments, and is common in commercial real estate and business financing.";
        ...
        emit TermAddedOrUpdated("Balloon Loan", terms["Balloon Loan"]);
    }
