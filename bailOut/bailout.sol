...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bail Out"] = "Financial assistance provided by a government or external entity to a failing company or institution to prevent systemic collapse, stabilize the economy, and maintain market confidence.";
        ...
        emit TermAddedOrUpdated("Bail Out", terms["Bail Out"]);
    }
