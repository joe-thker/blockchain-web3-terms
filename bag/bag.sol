...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bag"] = "In crypto and investment slang, a 'bag' refers to the holdings or amount of an asset that an investor possesses. It is often used to describe long-term positions, and when the asset's value drops significantly, the investor is said to be 'bagholding.'";
        ...
        emit TermAddedOrUpdated("Bag", terms["Bag"]);
    }
