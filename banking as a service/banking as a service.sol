...
/// @notice A contract to store and retrieve various technical, financial, and business terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Banking as a Service"] = "A business model where licensed banks provide their digital banking infrastructure and regulatory compliance to third-party companies, enabling them to integrate banking services into their own applications without having to become fully licensed banks.";
        ...
        emit TermAddedOrUpdated("Banking as a Service", terms["Banking as a Service"]);
    }
