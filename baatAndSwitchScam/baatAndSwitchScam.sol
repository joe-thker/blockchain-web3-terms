...
/// @notice A contract to store and retrieve various technical, financial, and marketing terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bait and Switch Scam"] = "A deceptive marketing tactic in which a seller advertises a product at a low price (the bait) to attract customers, then reveals that the product is unavailable or inferior and directs customers to purchase a more expensive alternative (the switch).";
        ...
        emit TermAddedOrUpdated("Bait and Switch Scam", terms["Bait and Switch Scam"]);
    }
