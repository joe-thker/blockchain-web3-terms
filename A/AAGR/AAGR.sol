...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Annual Growth Rate"] = "A measure that calculates the average yearly increase (or decrease) in the value of an investment or asset over a period, expressed as a percentage. It is used for performance analysis, forecasting, and comparative analysis of investments or business metrics.";
        ...
        emit TermAddedOrUpdated("Average Annual Growth Rate", terms["Average Annual Growth Rate"]);
    }
