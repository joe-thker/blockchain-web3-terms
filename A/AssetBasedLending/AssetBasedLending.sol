...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset Based Lending"] = "A financing method where loans are secured by collateral assets such as inventory, accounts receivable, equipment, or real estate. It is used for working capital financing, business expansion, risk management, and alternative financing.";
        ...
        emit TermAddedOrUpdated("Asset Based Lending", terms["Asset Based Lending"]);
    }
