...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Arbitrage Pricing Theory (APT)"] = "An asset pricing model that explains the expected return of a financial asset as a linear function of various macroeconomic risk factors. APT is used for estimating risk and return, portfolio diversification, asset pricing, and as an alternative to CAPM.";
        ...
        emit TermAddedOrUpdated("Arbitrage Pricing Theory (APT)", terms["Arbitrage Pricing Theory (APT)"]);
    }
