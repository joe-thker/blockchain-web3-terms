...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Anti-Dump Policy"] = "A set of measures designed to prevent or mitigate the rapid sale (dumping) of assets, thereby protecting market stability, investor interests, and long-term value. It is used to stabilize markets, protect retail investors, and encourage long-term holding.";
        ...
        emit TermAddedOrUpdated("Anti-Dump Policy", terms["Anti-Dump Policy"]);
    }
