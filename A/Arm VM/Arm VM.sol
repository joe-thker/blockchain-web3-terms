...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["ARM Virtual Machine"] = "A software emulation of the ARM architecture that allows ARM-based code to run on non-ARM hardware. It is used for cross-platform development, testing, legacy application support, cloud computing, and educational purposes.";
        ...
        emit TermAddedOrUpdated("ARM Virtual Machine", terms["ARM Virtual Machine"]);
    }
