...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Daily Trading Volume"] = "The average amount of an asset traded per day over a specific period. It is used to assess market liquidity, analyze market sentiment, manage risk, and compare asset activity levels.";
        ...
        emit TermAddedOrUpdated("Average Daily Trading Volume", terms["Average Daily Trading Volume"]);
    }
