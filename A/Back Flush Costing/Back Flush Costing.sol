...
/// @notice A contract to store and retrieve various technical, financial, and manufacturing terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Back Flush Costing"] = "A costing method used in manufacturing where costs are recorded after production is complete, rather than tracking costs continuously through each production stage. It is particularly useful in lean manufacturing and just-in-time production environments.";
        ...
        emit TermAddedOrUpdated("Back Flush Costing", terms["Back Flush Costing"]);
    }
