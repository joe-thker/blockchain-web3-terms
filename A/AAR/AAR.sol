...
/// @notice A contract to store and retrieve various technical, financial, and economic terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Annual Return"] = "A measure of the average yearly return of an investment over a specified period, calculated as the simple average of annual returns. It is used to evaluate investment performance, compare different investments, and assist in portfolio management.";
        ...
        emit TermAddedOrUpdated("Average Annual Return", terms["Average Annual Return"]);
    }
