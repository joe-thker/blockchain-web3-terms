...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["AR Token (Arweave)"] = "The native cryptocurrency of the Arweave network, used for permanent data storage, incentivizing decentralized data preservation, and supporting dApp utility and governance on the permaweb.";
        ...
        emit TermAddedOrUpdated("AR Token (Arweave)", terms["AR Token (Arweave)"]);
    }
