...
/// @notice A contract to store and retrieve various technical, financial, and regulatory terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Auditor"] = "An independent professional or firm that examines and verifies an organization's financial records, internal controls, and compliance with relevant laws and standards. Used for financial audits, compliance reviews, risk management, and strengthening internal controls.";
        ...
        emit TermAddedOrUpdated("Auditor", terms["Auditor"]);
    }
