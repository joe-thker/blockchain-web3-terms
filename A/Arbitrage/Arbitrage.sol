...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Arbitrage"] = "A trading strategy that involves simultaneously buying and selling an asset in different markets to profit from price discrepancies. Used to enhance market efficiency, capture risk-free profit opportunities, and power algorithmic trading strategies.";
        ...
        emit TermAddedOrUpdated("Arbitrage", terms["Arbitrage"]);
    }
