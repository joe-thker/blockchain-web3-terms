...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["AMM"] = "Automated Market Maker: A decentralized exchange protocol that uses liquidity pools and mathematical formulas (such as the constant product formula) to set asset prices, enabling trustless and continuous trading without traditional order books.";
        ...
        emit TermAddedOrUpdated("AMM", terms["AMM"]);
    }
