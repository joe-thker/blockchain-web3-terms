...
/// @notice A contract to store and retrieve various technical, financial, and crypto-related terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Ashdraked"] = "A slang term used in the crypto community to describe a situation where an investor suffers severe losses, often leaving them with little or nothing. It serves as both a humorous caution and a reminder of the risks involved in volatile markets.";
        ...
        emit TermAddedOrUpdated("Ashdraked", terms["Ashdraked"]);
    }
