...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset Class"] = "A grouping of investments that share similar characteristics and behave similarly in the market (e.g., equities, fixed income, cash, real estate, commodities). Used for portfolio diversification, risk management, investment analysis, and strategic capital allocation.";
        ...
        emit TermAddedOrUpdated("Asset Class", terms["Asset Class"]);
    }
