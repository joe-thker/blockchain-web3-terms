...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset"] = "Any resource, tangible or intangible, that is owned by an individual or entity and holds economic value. Assets can be used for generating income, serving as collateral, or trading. Examples include real estate, equipment, intellectual property, stocks, bonds, and digital currencies.";
        ...
        emit TermAddedOrUpdated("Asset", terms["Asset"]);
    }
