...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Antpool"] = "One of the largest Bitcoin mining pools, where individual miners combine their hashing power to increase their chances of mining blocks and earning rewards, which are then distributed based on contributed power.";
        ...
        emit TermAddedOrUpdated("Antpool", terms["Antpool"]);
    }
