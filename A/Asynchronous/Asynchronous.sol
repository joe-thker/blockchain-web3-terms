...
/// @notice A contract to store and retrieve various technical, financial, and computing terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asynchronous"] = "A process that operates independently of the main program flow, allowing multiple tasks to run concurrently without waiting for each other to complete. It is widely used in UI design, network communications, event-driven programming, and parallel processing.";
        ...
        emit TermAddedOrUpdated("Asynchronous", terms["Asynchronous"]);
    }
