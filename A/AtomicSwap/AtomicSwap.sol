...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Atomic Swap"] = "A trustless, peer-to-peer exchange mechanism that allows two parties to swap cryptocurrencies across different blockchains without intermediaries, using protocols like hash time-locked contracts (HTLCs) to ensure the swap is atomic.";
        ...
        emit TermAddedOrUpdated("Atomic Swap", terms["Atomic Swap"]);
    }
