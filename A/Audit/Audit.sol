...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Audit"] = "A systematic, independent, and documented examination of financial records, operational processes, or systems to ensure accuracy, compliance, and effective internal controls. It is used for financial, compliance, operational, and security reviews.";
        ...
        emit TermAddedOrUpdated("Audit", terms["Audit"]);
    }
