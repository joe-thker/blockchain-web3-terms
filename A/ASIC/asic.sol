...
/// @notice A contract to store and retrieve various technical, financial, and industry-specific terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["ASIC"] = "Application-Specific Integrated Circuit: a microchip designed for a particular application, offering optimized performance and efficiency. Commonly used in cryptocurrency mining, telecommunications, consumer electronics, and industrial applications.";
        ...
        emit TermAddedOrUpdated("ASIC", terms["ASIC"]);
    }
