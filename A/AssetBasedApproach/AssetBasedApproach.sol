...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset Based Approach"] = "A method of valuation that focuses on determining the value of an entity based on its underlying assets. It is used in company valuation, collateral evaluation, risk management, and liquidation analysis.";
        ...
        emit TermAddedOrUpdated("Asset Based Approach", terms["Asset Based Approach"]);
    }
