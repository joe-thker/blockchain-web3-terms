...
/// @notice A contract to store and retrieve various technical, financial, and software terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["API"] = "Application Programming Interface: a set of protocols, routines, and tools that enable software applications to communicate with each other. Used for data integration, service communication, accessing third-party services, automation, and connecting mobile/web applications.";
        ...
        emit TermAddedOrUpdated("API", terms["API"]);
    }
