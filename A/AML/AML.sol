...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["AML"] = "Anti-Money Laundering: A set of laws, regulations, and procedures designed to prevent criminals from disguising illegally obtained funds as legitimate income. Used by financial institutions and other regulated entities for regulatory compliance, risk management, and customer due diligence.";
        ...
        emit TermAddedOrUpdated("AML", terms["AML"]);
    }
