...
/// @notice A contract to store and retrieve various financial, technical, and crypto terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Apeing"] = "A slang term used in the crypto community to describe impulsively buying a new or hyped asset without thorough research, driven by FOMO.";
        ...
        emit TermAddedOrUpdated("Apeing", terms["Apeing"]);
    }
