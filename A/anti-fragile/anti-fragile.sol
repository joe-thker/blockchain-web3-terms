...
/// @notice A contract to store and retrieve various technical, financial, and conceptual terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Anti-Fragile"] = "A property of systems that benefit and grow stronger from shocks, volatility, and disorder. It is used in risk management, finance, business strategy, system design, and personal development to create robust and adaptive processes.";
        ...
        emit TermAddedOrUpdated("Anti-Fragile", terms["Anti-Fragile"]);
    }
