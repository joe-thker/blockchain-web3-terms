...
/// @notice A contract to store and retrieve various financial and technical terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Ask Price"] = "The lowest price at which a seller is willing to sell an asset at a given time. It is used in trading for order execution, price discovery, and market analysis.";
        ...
        emit TermAddedOrUpdated("Ask Price", terms["Ask Price"]);
    }
