...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Return"] = "A financial metric that represents the simple arithmetic mean of an investment's returns over a specified period. It is used to evaluate investment performance, compare different investments, and support financial forecasting and portfolio management.";
        ...
        emit TermAddedOrUpdated("Average Return", terms["Average Return"]);
    }
