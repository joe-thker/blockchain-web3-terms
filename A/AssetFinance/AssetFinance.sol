...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset Finance"] = "A financing method that uses a company's assets as collateral to secure a loan or lease, enabling businesses to acquire expensive assets, manage cash flow, and support expansion while mitigating lender risk.";
        ...
        emit TermAddedOrUpdated("Asset Finance", terms["Asset Finance"]);
    }
