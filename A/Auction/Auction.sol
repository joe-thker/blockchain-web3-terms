...
/// @notice A contract to store and retrieve various technical, financial, and auction-related terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Auction"] = "A process where an asset is sold to the highest bidder. It is used for price discovery, competitive asset sales, procurement, fundraising, and selling digital or physical collectibles.";
        ...
        emit TermAddedOrUpdated("Auction", terms["Auction"]);
    }
