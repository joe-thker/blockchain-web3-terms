...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["AEA (Autonomous Economic Agent)"] = "A self-governing software entity that independently makes economic decisions, executes transactions, and manages resources using pre-defined algorithms or AI. Commonly used in automated trading, decentralized finance, smart contract interactions, and resource optimization.";
        ...
        emit TermAddedOrUpdated("AEA (Autonomous Economic Agent)", terms["AEA (Autonomous Economic Agent)"]);
    }
