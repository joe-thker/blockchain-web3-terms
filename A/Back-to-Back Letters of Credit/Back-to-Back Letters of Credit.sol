...
/// @notice A contract to store and retrieve various technical, financial, and trade-related terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Back-to-Back Letters of Credit"] = "A financing arrangement in international trade where one letter of credit (L/C) is used as collateral to obtain another L/C, enabling a seller to finance payments to its suppliers using the buyer's credit as backing.";
        ...
        emit TermAddedOrUpdated("Back-to-Back Letters of Credit", terms["Back-to-Back Letters of Credit"]);
    }
