...
/// @notice A contract to store and retrieve various technical, financial, and social terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Astroturfing"] = "A practice where an organization creates a deceptive appearance of grassroots support or opposition by orchestrating fake campaigns or comments. Commonly used in marketing, political campaigns, online reputation management, and social media manipulation.";
        ...
        emit TermAddedOrUpdated("Astroturfing", terms["Astroturfing"]);
    }
