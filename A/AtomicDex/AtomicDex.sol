...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Atomic DEX"] = "A decentralized exchange that enables trustless, cross-chain trading of cryptocurrencies using atomic swaps (e.g., via hash time-locked contracts). It enhances security and decentralization by eliminating intermediaries.";
        ...
        emit TermAddedOrUpdated("Atomic DEX", terms["Atomic DEX"]);
    }
