...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Asset Swap"] = "A financial transaction where the cash flows of a fixed income asset are exchanged for floating rate payments, allowing investors to hedge interest rate risk, enhance yield, and adjust the risk profile of their portfolios.";
        ...
        emit TermAddedOrUpdated("Asset Swap", terms["Asset Swap"]);
    }
