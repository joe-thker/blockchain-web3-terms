...
/// @notice A contract to store and retrieve various financial, technical, and trading terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Arbitrageur"] = "An individual or entity that profits from buying an asset at a lower price in one market and simultaneously selling it at a higher price in another market. Used to promote market efficiency, capture risk-free profit opportunities, and facilitate algorithmic trading.";
        ...
        emit TermAddedOrUpdated("Arbitrageur", terms["Arbitrageur"]);
    }
