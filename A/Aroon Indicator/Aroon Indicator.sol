...
/// @notice A contract to store and retrieve various technical, financial, and trading terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Aroon Indicator"] = "A technical analysis tool that measures the time since the highest high and the lowest low over a specified period. It consists of Aroon Up and Aroon Down lines to assess trend strength and potential reversals.";
        ...
        emit TermAddedOrUpdated("Aroon Indicator", terms["Aroon Indicator"]);
    }
