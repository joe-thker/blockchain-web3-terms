...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Directional Index"] = "A technical indicator that measures the strength of a market trend, regardless of its direction. It is calculated using smoothed averages of the difference between the positive and negative directional indicators, with values ranging from 0 to 100. Higher values indicate stronger trends.";
        ...
        emit TermAddedOrUpdated("Average Directional Index", terms["Average Directional Index"]);
    }
