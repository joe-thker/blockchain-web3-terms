...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Assets Under Management (AUM)"] = "The total market value of the assets managed by an investment firm on behalf of its clients. It is used for performance measurement, fee calculation, investor marketing, and risk management.";
        ...
        emit TermAddedOrUpdated("Assets Under Management (AUM)", terms["Assets Under Management (AUM)"]);
    }
