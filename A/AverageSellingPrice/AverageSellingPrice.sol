...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Average Selling Price"] = "A financial metric representing the average price at which a product or asset is sold, calculated by dividing the total sales revenue by the number of units sold. It is used for sales performance analysis, inventory management, market benchmarking, and revenue forecasting.";
        ...
        emit TermAddedOrUpdated("Average Selling Price", terms["Average Selling Price"]);
    }
