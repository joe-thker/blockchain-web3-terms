...
/// @notice A contract to store and retrieve various financial, technical, and legal terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Antitrust Law"] = "A body of law that regulates the conduct and organization of business corporations to promote fair competition for the benefit of consumers, preventing monopolistic and anti-competitive practices.";
        ...
        emit TermAddedOrUpdated("Antitrust Law", terms["Antitrust Law"]);
    }
