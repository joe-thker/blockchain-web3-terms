...
/// @title Milestone-Based Initial Bounty Offering (IBO)
/// @notice Tokens are distributed when milestones are reached. Users receive rewards proportional to their contributions.
contract MilestoneIBO is Ownable {
