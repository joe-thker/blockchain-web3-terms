...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Basis Point"] = "A unit of measurement equal to 0.01% (1/100th of 1%). It is used to describe small changes in interest rates, bond yields, fees, and other financial percentages.";
        ...
        emit TermAddedOrUpdated("Basis Point", terms["Basis Point"]);
    }
