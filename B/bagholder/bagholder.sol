...
/// @notice A contract to store and retrieve various financial, technical, and crypto-related terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bag Holder"] = "A term used in investment and crypto communities referring to an investor who holds an asset that has significantly lost value. The investor continues to hold the asset, often hoping for a recovery, even though the asset is largely devalued.";
        ...
        emit TermAddedOrUpdated("Bag Holder", terms["Bag Holder"]);
    }
