...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Backorder"] = "An order placed for an item that is temporarily out of stock. The item will be delivered once it is back in stock. Used for managing inventory shortages, supply chain planning, customer retention, and demand forecasting.";
        ...
        emit TermAddedOrUpdated("Backorder", terms["Backorder"]);
    }
