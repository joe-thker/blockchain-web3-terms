...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Backtesting"] = "The process of testing a trading strategy or model using historical data to evaluate its potential performance, assess risk, and optimize parameters.";
        ...
        emit TermAddedOrUpdated("Backtesting", terms["Backtesting"]);
    }
