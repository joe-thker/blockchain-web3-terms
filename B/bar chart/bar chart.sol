...
/// @notice A contract to store and retrieve various technical, financial, and data visualization terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bar Chart"] = "A graphical representation of data using rectangular bars, where each bar's height or length represents the value of a category. Commonly used for comparative analysis, performance metrics, and trend visualization.";
        ...
        emit TermAddedOrUpdated("Bar Chart", terms["Bar Chart"]);
    }
