...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Bank Run"] = "A situation in which a large number of bank customers withdraw their deposits simultaneously, driven by fears of bank insolvency. This can deplete the bank's liquidity and lead to its collapse if not contained.";
        ...
        emit TermAddedOrUpdated("Bank Run", terms["Bank Run"]);
    }
