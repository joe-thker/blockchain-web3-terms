...
contract DiscriminatoryPriceBatchAuction {
    struct Bid {
        address bidder;
    ...
    event AuctionClosed(address[] winners);
    ...
    // Admin closes the auction and determines the winners.
    // Each winner pays the bid price they submitted.
    function closeAuction() public onlyAdmin {
        ...
        emit AuctionClosed(winnersList);
    }
}
