...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Balanced Investment Strategy"] = "An investment approach that diversifies across asset classes, typically combining equities for growth and bonds for stability, in order to manage risk while seeking moderate returns.";
        ...
        emit TermAddedOrUpdated("Balanced Investment Strategy", terms["Balanced Investment Strategy"]);
    }
