...
/// @notice A contract to store and retrieve various financial, technical, and regulatory terms along with their definitions.
contract TermsDictionary {
    ...
    constructor() {
        ...
        // Entry for Bank Secrecy Act (BSA)
        terms["Bank Secrecy Act"] = "A U.S. law, also known as the Currency and Foreign Transactions Reporting Act, that requires financial institutions to assist government agencies in detecting and preventing money laundering by maintaining records and filing reports on certain financial transactions.";
        ...
        emit TermAddedOrUpdated("Bank Secrecy Act", terms["Bank Secrecy Act"]);
    }
