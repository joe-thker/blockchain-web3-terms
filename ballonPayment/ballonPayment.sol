...
contract TermsDictionary {
    ...
    constructor() {
        ...
        terms["Balloon Payment"] = "A large lump-sum payment due at the end of a loan term. It allows for lower periodic payments during the loan term, with the remaining balance paid off in one final payment. Commonly used in mortgages, commercial real estate, and business financing.";
        ...
        emit TermAddedOrUpdated("Balloon Payment", terms["Balloon Payment"]);
    }
